...
func (app *App) rateLimitExceededResponse(w http.ResponseWriter, r *http.Request, retryAfter time.Duration) {
...
func (app *App) errorResponseWithHeaders(w http.ResponseWriter, r *http.Request, status int, message any, headers http.Header) {
	env := envelope{"error": message}
