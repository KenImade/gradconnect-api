...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/data.AnalyticsResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/admin/assessments": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search programme type or employer name (case-insensitive substring)",
                        "name": "q",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter to a single employer (UUID)",
                        "name": "employer_id",
                        "in": "query"
                    },
                    {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/data.Assessment"
                                            }
                                        },
                                        "pagination": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.CreateAssessmentInput"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.UpdateAssessmentInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.CreateEmployerInput"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.UpdateEmployerInput"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/data.ImportJob"
                                            }
                                        }
                                    }
                                }
        ...
        "/admin/jobs/cleanup-sessions": {
            "post": {
                "description": "Deletes all expired sessions from the database. Returns the count deleted.\nSafe to run multiple times. Requires admin:full permission.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/app.CleanupSessionsResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/admin/jobs/deadline-reminders": {
            "post": {
                "description": "Manually fires the deadline reminder enqueue job. Useful for testing in staging,\nrecovery from a missed cron, or admin-initiated re-runs. Returns the count of\nreminder jobs queued for execution. Requires admin:full permission.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/data.DeadlineReminderResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/admin/jobs/recalculate-ratings": {
            "post": {
                "description": "Recomputes cached avg_difficulty_rating, avg_experience_rating, and\nreview_count for every employer. Returns the number of employers processed.\nRequires admin:full permission.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/app.RecalcRatingsResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/admin/opportunities": {
            "get": {
                ...
                "description": "List all graduate opportunities including closed and withdrawn.\nAdmin-only ledger view of every record on the platform regardless of status.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Keyword search across title, employer name, location, discipline, industry, requirements, and description",
                        "name": "q",
                        "in": "query"
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "default": "all",
                        "description": "Filter by computed status. Admins may request any status, including closed and withdrawn, or 'all' to see every status.",
                        "name": "status",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Filter by programme intake year",
                        "name": "intake_year",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by employer's industry (exact match)",
                        "name": "industry",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Filter by discipline tag (array contains)",
                        "name": "discipline",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Show opportunities with deadline before this date (YYYY-MM-DD)",
                        "name": "deadline_before",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Show opportunities with deadline after this date (YYYY-MM-DD)",
                        "name": "deadline_after",
                        "in": "query"
                    },
                    {
                        ...
                        "type": "string",
                        "default": "-created_at",
                        "description": "Sort field (prefix with - for descending). Defaults to newest-first for admin moderation workflows.",
                        "name": "sort",
                        "in": "query"
                    },
                    {
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 50,
                        "description": "Items per page (max 50). Higher default than the public endpoint for bulk admin operations.",
                        "name": "page_size",
                        "in": "query"
                    }
                ],
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/data.Opportunity"
                                            }
                                        },
                                        "pagination": {
                                            "$ref": "#/definitions/data.Metadata"
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.CreateOpportunityInput"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.UpdateOpportunityInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/opportunities/{id}/image": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "PNG image of the opportunity card",
                        "schema": {
                            "type": "file"
                        }
                    },
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/data.AdminReview"
                                            }
                                        },
                                        "pagination": {
                                            "$ref": "#/definitions/data.Metadata"
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.ModerateReviewInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.ForgotPasswordInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.GoogleAuthInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.CreateUserInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.ResetPasswordInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/verify-email": {
            "get": {
                ...
                "responses": {
                    "302": {
                        "description": "Redirect to frontend failure page on invalid/expired token"
                    },
                    "422": {
        ...
        "/employers": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Full-text search across name, overview, industry, and location",
                        "name": "q",
                        "in": "query"
                    },
                    {
                    ...
                    },
                    {
                        "type": "string",
                        "default": "name",
                        "description": "Sort field: name, created_at (prefix with - for descending)",
                        "name": "sort",
                        "in": "query"
                    },
                    {
        ...
        "/employers/{slug}/assessments": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "default": "programme_type",
                        "description": "Sort field: programme_type, updated_at",
                        "name": "sort",
                        "in": "query"
                    },
                    {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/data.CurrentUserResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.UpdateUserInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.CreateApplicationInput"
                        }
                    }
                ],
                "responses": {
                    ...
                    "409": {
                        "description": "Already tracking this opportunity",
                        "schema": {
                            "$ref": "#/definitions/app.ErrorResponse"
                        }
                    },
        ...
        "/me/applications/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Application tracker ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.UpdateApplicationInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/me/bookmarks": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Opportunity to bookmark",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/app.addBookmarkInput"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "description": "Filter by computed status. Public consumers may only request open or upcoming listings (or both via 'open_or_upcoming').",
                        "name": "status",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.CreateReviewInput"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/data.UpdateReviewInput"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "app.ErrorResponse": {
            ...
            "properties": {
                "error": {
                    "description": "Can be a string or a map of validation errors"
                }
            }
        },
        "app.RecalcRatingsResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
        ...
        "data.AnalyticsResponse": {
            ...
            "properties": {
                "counts": {
                    "$ref": "#/definitions/data.AnalyticsCounts"
                },
                "recent_jobs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/data.RecentJob"
                    }
                },
                "time_series": {
                    "$ref": "#/definitions/data.AnalyticsTimeSeries"
                },
                "top_employers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/data.TopEmployer"
                    }
                },
                "top_opportunities": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/data.TopOpportunity"
                    }
                }
            }
        },
        "data.AnalyticsTimeSeries": {
            ...
            "properties": {
                "bookmarks": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/data.TimeSeriesPoint"
                    }
                },
                "registrations": {
                    "type": "array",
        ...
        "data.Assessment": {
            ...
            "properties": {
                ...
                "employer": {
                    "$ref": "#/definitions/data.EmployerStub"
                },
                "employer_id": {
                    "type": "string"
                },
        ...
        "data.CreateApplicationInput": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/data.ApplicationStatus"
                }
            }
        },
        ...
        "data.ImportJob": {
            ...
            "properties": {
                ...
                "row_errors": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/data.ImportJobRowError"
                    }
                },
                "rows_failed": {
                    "type": "integer"
